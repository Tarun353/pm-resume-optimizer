  ...
  return (
    <div className="space-y-3">
      <textarea
        ...
        placeholder="e.g. The internship section didn't show up in the edit window..."
        rows={3}
      ...
      <button
        ...
        className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-200 disabled:text-slate-400 text-white rounded-xl text-sm font-semibold transition-all">
          ...
          <div className="mt-16 border-t border-slate-200">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    LinkedIn profile optimizer · Interview prep questions from your resume · Resume score benchmarking · ATS keyword density checker · Multi-language support
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mb-4">Need help with your resume, payment, or anything else? Reach out directly.</p>
                  <div className="space-y-3">
                    <a href="tel:+916200825883" className="flex items-center gap-3 p-3 bg-slate-50 hover:bg-blue-50 rounded-xl transition-colors group">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-slate-800 group-hover:text-blue-700">+91 6200825883</p>
                      </div>
                    </a>
                    <a href="https://wa.me/916200825883" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-slate-50 hover:bg-green-50 rounded-xl transition-colors group">
                      ...
                      <div>
                        <p className="text-xs text-slate-500">Message on WhatsApp</p>
                        <p className="text-sm font-semibold text-slate-800 group-hover:text-green-700">Chat with us</p>
                      </div>
                    </a>
                  </div>
                </div>
                <p className="text-xs text-slate-400 mt-4">Typical response time: within a few hours</p>
              </div>
            </div>
            ...
            <div className="border-t border-slate-100 pt-6 pb-8">
              ...
              <p className="text-center text-xs text-slate-300 mt-3">
                Resume data is processed server-side only and never stored · Powered by Groq AI · LlamaParse · Puppeteer
              </p>
            </div>
